...
function languageInfo(languages) {
    ...
    if (languages.length === 3) return output + `${languages[0].name} and ${languages[1].name} and ${languages[2].name}`;
...
var Buffer = require("bd12f45568993e50").Buffer;
"use strict";
/**
...
},{"bd12f45568993e50":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("6b4465f3a0a85f90");
var ieee754 = require("ceaf06944d094ff9");
...
},{"6b4465f3a0a85f90":"eIiSV","ceaf06944d094ff9":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
